...
static syscall_ptr_t syscall_native_table[MAX_SYSCALL_NUM] = {
    ...
    [359] = (syscall_ptr_t)sys_socket,
    [360] = (syscall_ptr_t)sys_bind,
    [361] = (syscall_ptr_t)sys_connect,
    [362] = (syscall_ptr_t)sys_listen,
    [363] = (syscall_ptr_t)sys_accept4,
    [364] = (syscall_ptr_t)sys_sendto,
    [365] = (syscall_ptr_t)sys_recvfrom,
    [366] = (syscall_ptr_t)sys_sendmsg,
    [367] = (syscall_ptr_t)sys_recvmsg,
    [368] = (syscall_ptr_t)sys_shutdown,
    [369] = (syscall_ptr_t)sys_setsockopt,
    [370] = (syscall_ptr_t)sys_getsockopt,
    [371] = (syscall_ptr_t)sys_getpeername,
    [372] = (syscall_ptr_t)sys_getsockname,
