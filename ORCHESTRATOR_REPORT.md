...
1. **`userspace-libc-posix-bot`**: Continuar la expansión de libc para soportar la ejecución de GNU coreutils nativo, enfocándose en la completitud de la API POSIX (unistd.h, sys/stat.h, stdio.h, fcntl.h) requerida por las dependencias de GNU.
