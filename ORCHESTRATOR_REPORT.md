...
- Añadido `ctype.c` a los fuentes de libc en `userspace/Makefile` para arreglar problemas de enlazado al usar `isspace` en `sh.c`. El proyecto compila correctamente y bootea transicionando a Ring 3 sin Kernel Panics. Todos los subprocesos de las capas subyacentes operan de forma estable.
