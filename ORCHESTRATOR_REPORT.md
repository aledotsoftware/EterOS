...
- Se añadió `libc/src/ctype.c` a `LIBC_SRC` en `userspace/Makefile` para arreglar un error de enlazado al usar `isspace` en `sh.c`. El proyecto ahora compila y arranca limpiamente.
