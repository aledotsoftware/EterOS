...
int main() {
    ...
    printf("Testing unimplemented linux syscalls\n");
    assert(sys_getrusage(0, NULL) == -38); // -ENOSYS
    assert(sys_prlimit64(0, 0, NULL, NULL) == -38); // -ENOSYS
    assert(sys_syslog(0, NULL, 0) == -38); // -ENOSYS
