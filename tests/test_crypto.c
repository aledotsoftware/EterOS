...
void print_hash512(const uint8_t *hash) {
    for(int i=0; i<64; i++) {
        printf("%02x", hash[i]);
    }
    printf("\n");
...
int test_sha512() {
    ...
    if (memcmp(hash, expected1, 64) != 0) {
        printf("SHA-512 Test 1 Failed!\n");
        printf("Expected: "); print_hash512(expected1);
        printf("Got:      "); print_hash512(hash);
        return 1;
    }
    printf("SHA-512 Test 1 Passed\n");
    ...
    if (memcmp(hash, expected2, 64) != 0) {
        printf("SHA-512 Test 2 Failed!\n");
        printf("Expected: "); print_hash512(expected2);
        printf("Got:      "); print_hash512(hash);
        return 1;
    }
    printf("SHA-512 Test 2 Passed\n");
