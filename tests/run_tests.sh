...
gcc -D__ETEROS_HOST_TEST__ -Iinclude tests/mock_net.c tests/test_bcache.c kernel/string.c -o tests/test_bcache
./tests/test_bcache
...
gcc -D__ETEROS_HOST_TEST__ -Iinclude tests/mock_net.c tests/test_fat32.c kernel/string.c kernel/fs/bcache.c -o tests/test_fat32
./tests/test_fat32
rm tests/test_fat32
...
gcc -D__ETEROS_HOST_TEST__ -Iinclude tests/mock_net.c tests/test_jfs.c kernel/string.c -o tests/test_jfs
./tests/test_jfs
rm tests/test_jfs
...
gcc -D__ETEROS_HOST_TEST__ -Iinclude tests/mock_net.c tests/test_elf_read_failure.c -o tests/test_elf_read_failure
...
gcc -D__ETEROS_HOST_TEST__ -Iinclude tests/mock_net.c tests/test_ip_aton.c kernel/net/core/ip_utils.c -o tests/test_ip_aton
./tests/test_ip_aton
...
gcc -D__ETEROS_HOST_TEST__ -Iinclude tests/mock_net.c tests/test_readv_security.c tests/mock_pmm.c kernel/string.c -o tests/test_readv_security
...
gcc -O0 -g -D__ETEROS_HOST_TEST__ -Iinclude tests/mock_net.c tests/test_mmap_fixed.c kernel/string.c -o tests/test_mmap_fixed
...
gcc -D__ETEROS_HOST_TEST__ -Iinclude tests/mock_net.c tests/test_stdio.c kernel/stdio.c kernel/string.c -o tests/test_stdio
./tests/test_stdio
rm tests/test_stdio
...
gcc -D__ETEROS_HOST_TEST__ -Iinclude tests/mock_net.c tests/test_procfs.c -o tests/test_procfs
./tests/test_procfs
...
gcc -D__ETEROS_HOST_TEST__ -Iinclude tests/mock_net.c tests/test_devfs.c kernel/crypto/sha256.c -o tests/test_devfs
./tests/test_devfs
rm tests/test_devfs
...
gcc -D__ETEROS_HOST_TEST__ -Iinclude tests/mock_net.c tests/test_framebuffer_scroll.c kernel/drivers/video/font.c -o tests/test_framebuffer_scroll
...
gcc -D__ETEROS_HOST_TEST__ -Iinclude tests/mock_net.c tests/test_sem_logic.c -o tests/test_sem_logic
...
gcc -D__ETEROS_HOST_TEST__ -Iinclude tests/mock_net.c tests/test_sys_open.c tests/mock_pmm.c kernel/string.c -o tests/test_sys_open
./tests/test_sys_open
...
gcc -D__ETEROS_HOST_TEST__ -Iinclude tests/mock_net.c tests/test_sys_rw_perms.c tests/mock_pmm.c kernel/string.c -o tests/test_sys_rw_perms
...
gcc -D__ETEROS_HOST_TEST__ -Iinclude tests/mock_net.c tests/test_socket_security.c tests/mock_pmm.c kernel/string.c -o tests/test_socket_security
...
gcc -D__ETEROS_HOST_TEST__ -Iinclude tests/mock_net.c tests/test_vfs_readdir.c -o tests/test_vfs_readdir
...
gcc -D__ETEROS_HOST_TEST__ -Iinclude tests/mock_net.c tests/test_vfs_create_fs.c -o tests/test_vfs_create_fs
...
gcc -D__ETEROS_HOST_TEST__ -Iinclude tests/mock_net.c tests/test_futex_logic.c kernel/string.c -o tests/test_futex_logic
./tests/test_futex_logic
rm tests/test_futex_logic

echo "---------------------------------------------------"
echo "Running test_futex_timeout..."
gcc -D__ETEROS_HOST_TEST__ -Iinclude tests/mock_net.c tests/test_futex_timeout.c kernel/string.c -o tests/test_futex_timeout
...
gcc -D__ETEROS_HOST_TEST__ -Iinclude tests/mock_net.c tests/test_syscall_dispatch.c tests/mock_pmm.c kernel/string.c tests/vmm_map_page_mock.c -o tests/test_syscall_dispatch
...
gcc -D__ETEROS_HOST_TEST__ -Iinclude tests/mock_net.c tests/test_syscall_openat.c tests/mock_pmm.c kernel/string.c tests/vmm_map_page_mock.c -o tests/test_syscall_openat
...
gcc -D__ETEROS_HOST_TEST__ -Iinclude tests/mock_net.c tests/test_syscall_epoll.c tests/mock_pmm.c kernel/string.c tests/vmm_map_page_mock.c -o tests/test_syscall_epoll
...
gcc -D__ETEROS_HOST_TEST__ -Iinclude tests/mock_net.c tests/test_syscall_mmap_linux.c tests/mock_pmm.c kernel/string.c tests/vmm_map_page_mock.c -o tests/test_syscall_mmap_linux
...
gcc -D__ETEROS_HOST_TEST__ -Iinclude tests/mock_net.c tests/test_syscall_mmap_fixed.c tests/mock_pmm.c kernel/string.c tests/vmm_map_page_mock.c -o tests/test_syscall_mmap_fixed
./tests/test_syscall_mmap_fixed
rm tests/test_syscall_mmap_fixed

echo "---------------------------------------------------"
echo "Running test_syscall_clone..."
gcc -D__ETEROS_HOST_TEST__ -Iinclude tests/mock_net.c tests/test_syscall_linux_clone3.c tests/mock_pmm.c -o tests/test_syscall_linux_clone3
./tests/test_syscall_linux_clone3
rm tests/test_syscall_linux_clone3

gcc -D__ETEROS_HOST_TEST__ -Iinclude tests/mock_net.c tests/test_syscall_clone.c tests/mock_pmm.c kernel/string.c tests/vmm_map_page_mock.c -o tests/test_syscall_clone
./tests/test_syscall_clone
rm tests/test_syscall_clone

echo "---------------------------------------------------"
echo "Running test_syscall_pipe2..."
gcc -D__ETEROS_HOST_TEST__ -Iinclude tests/mock_net.c tests/test_syscall_pipe2.c tests/mock_pmm.c kernel/string.c tests/vmm_map_page_mock.c -o tests/test_syscall_pipe2
./tests/test_syscall_pipe2
rm tests/test_syscall_pipe2

echo "---------------------------------------------------"
echo "Running test_syscall_rt_sigaction..."
gcc -D__ETEROS_HOST_TEST__ -Iinclude tests/mock_net.c tests/test_syscall_rt_sigaction.c tests/mock_pmm.c kernel/string.c tests/vmm_map_page_mock.c -o tests/test_syscall_rt_sigaction
...
gcc -D__ETEROS_HOST_TEST__ -Iinclude tests/mock_net.c tests/test_syscall_linux_readlink.c tests/mock_pmm.c kernel/string.c -o tests/test_syscall_linux_readlink
...
gcc -D__ETEROS_HOST_TEST__ -Iinclude tests/mock_net.c tests/test_wget_parse_url.c kernel/string.c -o tests/test_wget_parse_url
...
gcc -D__ETEROS_HOST_TEST__ -Iinclude tests/mock_net.c tests/test_vfs_normalize_path.c -o tests/test_vfs_normalize_path
...
gcc -D__ETEROS_HOST_TEST__ -Iinclude tests/mock_net.c tests/test_vfs_mkdir.c -o tests/test_vfs_mkdir
./tests/test_vfs_mkdir
rm tests/test_vfs_mkdir
echo "---------------------------------------------------"
echo "Running test_syscall_sysinfo..."
gcc -D__ETEROS_HOST_TEST__ -Iinclude tests/mock_net.c tests/test_syscall_sysinfo.c kernel/string.c tests/vmm_map_page_mock.c -o tests/test_syscall_sysinfo
