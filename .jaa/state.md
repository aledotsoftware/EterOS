...
- Fix de glue / integración: Añadido `ctype.c` a los fuentes de libc en `userspace/Makefile` para arreglar problemas de enlazado al usar `isspace` en `sh.c`. El sistema compila y bootea de forma limpia.
